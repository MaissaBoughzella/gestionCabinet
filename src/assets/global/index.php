...
<!-- Mirrored from getbootstrapadmin.com/remark/material/mmenu/pages/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jan 2020 08:12:52 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="mmenu/assets/css/site.minfd53.css?v4.0.1">

  <!-- Skin tools (demo site only) -->
  <link rel="stylesheet" href="global/css/skintools.minfd53.css?v4.0.1">
  <script src="mmenu/assets/js/Plugin/skintools.minfd53.js?v4.0.1"></script>
  ...
  <!-- Page -->
  <link rel="stylesheet" href="mmenu/assets/examples/css/pages/login.minfd53.css?v4.0.1">
...
<body class="animsition site-navbar-small page-login layout-full page-dark">
  ...
  <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">>
    <div class="page-content vertical-align-middle">
      <div class="brand">
        <img class="brand-img" src="mmenu/assets/images/logo.png" alt="...">
        <h2 class="brand-text">KAM - IT</h2>
      </div>
      <p>Sign into your pages account</p>
      <form method="post" action="mmenu/index.php">
  ...
  <script src="mmenu/assets/js/Section/Menubar.minfd53.js?v4.0.1"></script>
  <script src="mmenu/assets/js/Section/Sidebar.minfd53.js?v4.0.1"></script>
  <script src="mmenu/assets/js/Section/PageAside.minfd53.js?v4.0.1"></script>
  <script src="mmenu/assets/js/Section/GridMenu.minfd53.js?v4.0.1"></script>
  <!-- Config -->
  <script src="global/js/config/colors.minfd53.js?v4.0.1"></script>
  <script src="mmenu/assets/js/config/tour.minfd53.js?v4.0.1"></script>
  <script>
    Config.set('assets', 'mmenu/assets');
  </script>

  <!-- Page -->
  <script src="mmenu/assets/js/Site.minfd53.js?v4.0.1"></script>
